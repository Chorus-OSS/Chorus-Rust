...
use crate::level::block::r#impl::property::enums::attachment::Attachment;
use crate::level::block::r#impl::property::enums::bamboo_leaf_size::BambooLeafSize;
use crate::level::block::r#impl::property::enums::bamboo_stalk_thickness::BambooStalkThickness;
use crate::level::block::r#impl::property::enums::big_dripleaf_tilt::BigDripleafTilt;
use crate::level::block::r#impl::property::enums::cauldron_liquid::CauldronLiquid;
use crate::level::block::r#impl::property::enums::chemistry_table_type::ChemistryTableType;
use crate::level::block::r#impl::property::enums::chisel_type::ChiselType;
use crate::level::block::r#impl::property::enums::color::Color;
use crate::level::block::r#impl::property::enums::coral_color::CoralColor;
use crate::level::block::r#impl::property::enums::cracked_state::CrackedState;
use crate::level::block::r#impl::property::enums::creaking_heart_state::CreakingHeartState;
use crate::level::block::r#impl::property::enums::damage::Damage;
use crate::level::block::r#impl::property::enums::dirt_type::DirtType;
use crate::level::block::r#impl::property::enums::double_plant_type::DoublePlantType;
use crate::level::block::r#impl::property::enums::dripstone_thickness::DripstoneThickness;
use crate::level::block::r#impl::property::enums::level_direction::LeverDirection;
use crate::level::block::r#impl::property::enums::minecraft_cardinal_direction::MinecraftCardinalDirection;
use crate::level::block::r#impl::property::enums::minecraft_vertical_half::MinecraftVerticalHalf;
use crate::level::block::r#impl::property::enums::monster_egg_stone_type::MonsterEggStoneType;
use crate::level::block::r#impl::property::enums::new_leaf_type::NewLeafType;
use crate::level::block::r#impl::property::enums::old_leaf_type::OldLeafType;
use crate::level::block::r#impl::property::enums::orientation::Orientation;
use crate::level::block::r#impl::property::enums::pale_moss_carpet_side::PaleMossCarpetSide;
use crate::level::block::r#impl::property::enums::portal_axis::PortalAxis;
use crate::level::block::r#impl::property::enums::prismarine_block_type::PrismarineBlockType;
use crate::level::block::r#impl::property::enums::sand_type::SandType;
use crate::level::block::r#impl::property::enums::sea_grass_type::SeaGrassType;
use crate::level::block::r#impl::property::enums::sponge_type::SpongeType;
use crate::level::block::r#impl::property::enums::stone_brick_type::StoneBrickType;
use crate::level::block::r#impl::property::enums::stone_slab_type::StoneSlabType;
use crate::level::block::r#impl::property::enums::stone_slab_type_2::StoneSlabType2;
use crate::level::block::r#impl::property::enums::stone_slab_type_3::StoneSlabType3;
use crate::level::block::r#impl::property::enums::stone_slab_type_4::StoneSlabType4;
use crate::level::block::r#impl::property::enums::structure_block_type::StructureBlockType;
use crate::level::block::r#impl::property::enums::structure_void_type::StructureVoidType;
use crate::level::block::r#impl::property::enums::tall_grass_type::TallGrassType;
use crate::level::block::r#impl::property::enums::torch_facing_direction::TorchFacingDirection;
use crate::level::block::r#impl::property::enums::turtle_egg_count::TurtleEggCount;
use crate::level::block::r#impl::property::enums::vault_state::VaultState;
use crate::level::block::r#impl::property::enums::wall_block_type::WallBlockType;
use crate::level::block::r#impl::property::enums::wall_connection_type::WallConnectionType;
use crate::level::block::r#impl::property::enums::wood_type::WoodType;
